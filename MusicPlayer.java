...
public class MusicPlayer {
    ...
    public static void playNext(Context context, final long[] list, final long sourceId, final IdType sourceType) {
        ...
        try {
            ...
            final String message = makeLabel(context, com.hanan.music.R.plurals.NNNtrackstoqueue, list.length);
    ...
    public static void addToPlaylist(final Context context, final long[] ids, final long playlistid) {
        ...
        final String message = context.getResources().getQuantityString(
                com.hanan.music.R.plurals.NNNtrackstoplaylist, numinserted, numinserted);
        Toast.makeText(context, message, Toast.LENGTH_SHORT).show();
    }
