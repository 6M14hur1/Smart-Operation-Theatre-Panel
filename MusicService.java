...
import com.hanan.music.helpers.MediaButtonIntentReceiver;
import com.hanan.music.helpers.MusicPlaybackTrack;
import com.hanan.music.permissions.Nammu;
import com.hanan.music.provider.MusicPlaybackState;
import com.hanan.music.provider.RecentStore;
import com.hanan.music.provider.SongPlayCount;
...
import com.hanan.music.utils.TimberUtils.IdType;
...
public class MusicService extends Service {
    ...
    private Notification buildNotification() {
        ...
        int playButtonResId = isPlaying
                ? com.hanan.music.R.drawable.ic_pause_white_36dp : com.hanan.music.R.drawable.ic_play_white_36dp;
        ...
        if (artwork == null) {
            artwork = ImageLoader.getInstance().loadImageSync("drawable://" + com.hanan.music.R.drawable.ic_empty_music2);
        }
        ...
        android.support.v4.app.NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .setSmallIcon(com.hanan.music.R.drawable.ic_notification)
                .setLargeIcon(artwork)
                .setContentIntent(clickIntent)
                .setContentTitle(getTrackName())
                .setContentText(text)
                .setWhen(mNotificationPostTime)
                .addAction(com.hanan.music.R.drawable.ic_skip_previous_white_36dp,
                        "",
                        retrievePlaybackAction(PREVIOUS_ACTION))
                .addAction(playButtonResId, "",
                        retrievePlaybackAction(TOGGLEPAUSE_ACTION))
                .addAction(com.hanan.music.R.drawable.ic_skip_next_white_36dp,
                        "",
